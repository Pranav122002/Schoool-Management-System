...
class UpdateStudent implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b) {
            try {
                conn con = new conn();
                String str = "update student set first_name='" + t1.getText() + "',last_name='" + t2.getText()
                        + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',address='" + t5.getText()
                        + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',mother_tongue='" + t8.getText()
                        + "',standard='" + t9.getText() + "',aadhar='" + t10.getText() + "' where rollno='"
                        + t11.getText() + "'";
