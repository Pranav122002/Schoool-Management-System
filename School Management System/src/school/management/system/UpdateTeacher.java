...
class UpdateTeacher implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update teacher set first_name='"+t1.getText()+"',last_name='"+t2.getText()+"',age='"+t3.getText()
                        +"',dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()
                        +"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()
                        +"',aadhar='"+t10.getText()+"',education = '"+t11.getText()+"',subject='"+t12.getText()
                        +"' where emp_id='"+t13.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from teacher where emp_id = '" + t15.getText() + "'";
